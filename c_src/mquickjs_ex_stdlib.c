/*
 * MquickjsEx stdlib definition
 *
 * Based on mqjs_stdlib.c from MQuickJS, modified for Elixir NIF embedding.
 * Removes REPL-specific functions (gc, load, setTimeout, clearTimeout).
 */
#include <math.h>
#include <stdio.h>
#include <string.h>

#include "vendor/mquickjs_build.h"
...
/* Global object - no REPL functions (gc, load, setTimeout, clearTimeout) */
...
/* C function declarations needed for bind */
